...
regenie \
  ...
  --keep /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3_male/02.keep_male.tsv \
  --covarFile /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3_male/02.covariate_male.tsv \
  --phenoFile /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3_male/02.pheno_male.tsv \
  --bsize 1000 \
