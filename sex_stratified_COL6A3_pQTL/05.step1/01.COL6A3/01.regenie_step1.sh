...
regenie \
  ...
  --covarFile /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3/02.covariate.tsv \
  --phenoFile /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3/02.pheno.tsv \
  --bsize 1000 \
