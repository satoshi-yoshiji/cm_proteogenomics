...
regenie \
  ...
  --keep /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3_male_RNT/02.keep_male.tsv \
  --chr ${SLURM_ARRAY_TASK_ID} \
  --covarFile /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3_male_RNT/02.covariate_male.tsv \
  --phenoFile /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/03.pheno/01.COL6A3_male_RNT/02.pheno_male.tsv \
  --range 2:238232752-238232752 \
  --bsize 200 \
  --phenoCol Protein_level \
  --threads 16 \
  --pred /scratch/richards/satoshi.yoshiji/30.pQTL_regenie/05.step1/01.COL6A3_male_RNT/fit_bin_out_pred.list --ref-first \
