...
setwd('/home/richards/satoshi.yoshiji/scratch/30.pQTL_regenie/06.step2/01.COL6A3_male_RNT')
...
# save
write_tsv(combined_gwas, file = 'output/COL6A3.combined.Protein_level.regenie.gz')
