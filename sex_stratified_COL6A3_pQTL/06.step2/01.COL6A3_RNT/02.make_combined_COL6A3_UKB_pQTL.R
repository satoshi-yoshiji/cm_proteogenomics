...
setwd('/home/richards/satoshi.yoshiji/scratch/30.pQTL_regenie/06.step2/01.COL6A3_RNT')

per_chr_pqtl_list <- list.files('/scratch/richards/satoshi.yoshiji/30.pQTL_regenie/06.step2/01.COL6A3_RNT/output', full.names = T)
