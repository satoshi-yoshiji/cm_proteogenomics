...
plink2 --bgen /scratch/richards/restricted/ukb-general/scratch/genetic-data/genome/imputed.v3/bgen/${chr}.bgen 'ref-first' \
	   --sample /project/richards/restricted/ukb-27449/data/ukb27449_imp_chr1_v3_s487395_20210201.sample \
	   --autosome --mac 50 \
	   --extract /scratch/richards/satoshi.yoshiji/08.UKB/maf0.0001_info0.8.snp.lst \
	   --export bgen-1.2 \
