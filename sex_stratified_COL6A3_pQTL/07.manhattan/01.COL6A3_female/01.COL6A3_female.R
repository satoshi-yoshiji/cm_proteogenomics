...
setwd("/home/richards/satoshi.yoshiji/scratch/30.pQTL_regenie/07.manhattan/01.COL6A3_female/")

gwas_all <- data.frame()
for(i in 1:22){
  gwas_chr <- fread(paste0('/scratch/richards/satoshi.yoshiji/30.pQTL_regenie/06.step2/01.COL6A3_female/output/COL6A3.chr', i, '_Protein_level.regenie'))
